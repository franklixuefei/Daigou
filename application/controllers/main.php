...
//        echo $this->current_user;
    ...
    public function get_result() {
        ...
        $req->setFields("sell_promise,detail_url,title,desc,pic_url,num,list_time,delist_time,stuff_status,location,price,post_fee,express_fee,ems_fee,has_discount,has_invoice,has_warranty,approve_status");
